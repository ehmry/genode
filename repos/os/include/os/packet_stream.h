	...
	public:
		...
		:
			...
			_ack_receiver(construct_at<Ack_queue>(_ack_queue_local_base(),
			                                      Ack_queue::CONSUMER))
		{
			/* re-align the start of the buffer to 64 bytes */
			Genode::off_t aligned_offset = align_addr(_bulk_buffer_offset, 6);
			_bulk_buffer_size -= aligned_offset - _bulk_buffer_offset;
			_bulk_buffer_offset = aligned_offset;
