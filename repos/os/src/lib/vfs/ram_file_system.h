...
struct Vfs_ram::Handle final : public  Vfs_handle,
                               private Genode::List<Handle>::Element
{
	friend Genode::List<Handle>;
...
class Vfs_ram::Node : private Genode::Avl_node<Node>, private Genode::Lock
{
	private:
		...
		friend class Genode::List<Handle>;
		friend class Genode::List<Handle>::Element;
