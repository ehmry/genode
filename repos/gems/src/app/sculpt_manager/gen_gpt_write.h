...
#ifndef _GEN_GPT_WRITE_H_
#define _GEN_GPT_WRITE_H_
...
template <typename GEN_ACTIONS_FN>
void Sculpt_manager::_gen_gpt_write_start_content(Xml_generator        &xml,
...
void Sculpt_manager::gen_gpt_relabel_start_content(Xml_generator        &xml,
                                                   Storage_device const &device)
{
...
void Sculpt_manager::gen_gpt_expand_start_content(Xml_generator        &xml,
                                                  Storage_device const &device)
{
