...
#ifndef _GEN_WIFI_DRV_H_
#define _GEN_WIFI_DRV_H_

#include "xml.h"

namespace Sculpt_manager { void gen_wifi_drv_start_content(Xml_generator &); }


void Sculpt_manager::gen_wifi_drv_start_content(Xml_generator &xml)
{
