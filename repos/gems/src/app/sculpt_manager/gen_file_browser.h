...
#ifndef _GEN_FILE_BROWSER_H_
#define _GEN_FILE_BROWSER_H_
...
void Sculpt_manager::gen_nit_fb_start(Xml_generator &xml, Rom_name const &name)
{
...
void Sculpt_manager::gen_terminal_start(Xml_generator &xml, Rom_name const &name,
...
void Sculpt_manager::gen_noux_start(Xml_generator &xml, Rom_name const &name,
...
void Sculpt_manager::gen_file_browser(Xml_generator &xml,
                                      Storage_devices const &devices,
                                      Ram_fs_state const &ram_fs_state,
                                      File_browser_version version)
{
