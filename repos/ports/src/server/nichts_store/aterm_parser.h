...
#ifndef _NICHTS_STORE__ATERM_PARSER_H_
#define _NICHTS_STORE__ATERM_PARSER_H_
	...
	public:
		...
		class String : public Genode::List<String>::Element
		{
			...
			public:
				...
				String() { }
				String(char const *start, size_t len) : _start(start), _len(len) { }
				...
				{
					Genode::strncpy(dst, _start, min(_len+1, max_len));
				}
